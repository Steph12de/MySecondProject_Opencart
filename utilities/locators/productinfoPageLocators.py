...
class ProductInfoPageLocators:
    ...
    left_arrow_button = (By.XPATH, "//div[contains(@class,'bootstrap-datetimepicker-widget') and contains(@class,'picker-open')]//div[@class='datepicker-days']//table//thead//tr[1]//th[3]")
    right_arrow_button = (By.XPATH, "//div[contains(@class,'bootstrap-datetimepicker-widget') and contains(@class,'picker-open')]//div[@class='datepicker-days']//table//thead//tr[1]//th[1]")
    ...
    calendar_hour_arrow_button = (By.XPATH, "//div[contains(@class,'bootstrap-datetimepicker-widget') and contains(@class,'picker-open')]//div[@class='timepicker-picker']//table//tbody//tr[1]//td[1]//span")
    calendar_minutes_arrow_button = (By.XPATH, "//div[contains(@class,'bootstrap-datetimepicker-widget') and contains(@class,'picker-open')]//div[@class='timepicker-picker']//table//tbody//tr[1]//td[3]//span")
