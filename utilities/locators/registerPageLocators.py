...
class RegisterPageLocators:
    ...
    eMail_warning_message = (By.XPATH, "E-Mail Address does not appear to be valid!")
    telephone_warning_message = (By.XPATH, "Telephone must be between 3 and 32 characters!")
    password_warning_message = (By.XPATH, "Password must be between 4 and 20 characters!")
